...
ANALYZE_INSTRUCTIONS = (
    ...
    "2. Give an overall verdict and a 0-100 score using THIS FIXED RUBRIC (apply it consistently so the "
    "same product always gets the same score). Start at 100 and deduct per serving:\n"
    "   - Saturated fat: -1 point per 5% of the daily limit (e.g. 42% of limit -> about -8).\n"
    "   - Sodium: -1 point per 5% of the daily limit.\n"
    "   - Added/total sugars: -1 point per 5% of the daily limit.\n"
    "   - Trans fat present: -15. Ultra-processed / long additive list: -10. Palm oil or refined oils: -5.\n"
    "   - Refined grains as the main ingredient: -5.\n"
    "   Then ADD back: +5 if a good fiber source (>=15% daily), +5 if a good protein source (>=15% daily), "
    "+10 if a whole/minimally-processed food. Clamp to 0-100 and round to the nearest 5.\n"
    "   Verdict bands: 70-100 = healthy, 40-69 = moderate, 0-39 = unhealthy.\n"
